...
```
"raw_metadata_Asthma"].value_counts(dropna=False)
...
## 5. Gastrointestinal tract diseases/infections
```
...
```
## 7. subject_disease_status column
```
...
df.to_csv("kesken4.tsv", sep="\t", index=False)
```
## 10. raw_metadata_host_disease column
```
